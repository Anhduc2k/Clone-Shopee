          ...
          <S.InputLabel>
            ...
            <S.InputLabelContent>
              <Controller
                ...
                render={({ field }) => (
                  <InputPassword onChange={field.onChange} name="password" value={getValues('password')} />
                )}
              />
          ...
          <S.InputLabel>
            ...
            <S.InputLabelContent>
              <Controller
                ...
                rules={rules.password}
                render={({ field }) => (
                  <InputPassword onChange={field.onChange} name="new_password" value={getValues('new_password')} />
                )}
              />
